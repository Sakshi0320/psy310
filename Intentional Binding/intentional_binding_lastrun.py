...
expName = 'intentional_bonding'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/sakshi/Desktop/Experiments/Intentional Binding/intentional_binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/sakshi/Downloads/Intentional_bonding_trials - Sheet1.csv'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[Fixation, Polygon, key_resp],
        )
        ...
        while continueRoutine:
            ...
            if sound_1.status == NOT_STARTED and t >= delay-frameTolerance:
                # keep track of start time/frame for later
