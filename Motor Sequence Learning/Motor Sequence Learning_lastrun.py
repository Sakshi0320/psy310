...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/sakshi/Desktop/Experiments/Motor Sequence Learning/Motor Sequence Learning_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Fixation = visual.ShapeStim(
        ...
        lineWidth=1.0,
        colorSpace='rgb', lineColor=[-0.2549, 0.2392, 0.2549], fillColor=[-0.2549, 0.2392, 0.2549],
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('data/Sequence_Learning_Condition - Sheet1.csv'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[Fixation, line_1, line_2, line_3, line_4, probe, key_resp],
        )
